...
public interface ILessonService {
    Lesson addLesson(String lessonName , Long classroom, MultipartFile file) throws IOException;
    ResponseEntity<?> updateLesson(Lesson lesson, Long lessonId, MultipartFile file)throws IOException;
